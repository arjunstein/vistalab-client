                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}" wire:navigate :class="getActiveClasses('/dashboard')">
                            ...
                            <span class="ml-3"
                                :class="isActive('/dashboard') ? 'text-white font-medium' : ''">Dashboard</span>
                        </a>
                    </li>

                    {{-- User --}}
                    <li>
                        <a href="{{ route('list-user') }}" wire:navigate :class="getActiveClasses('/user')">
                            <svg :class="getIconClasses('/user')" aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 24 24">
                                <path stroke="currentColor" stroke-width="2"
                                    d="M7 17v1a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-1a3 3 0 0 0-3-3h-4a3 3 0 0 0-3 3Zm8-9a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                            </svg>
                            <span class="ml-3" :class="isActive('/user') ? 'text-white font-medium' : ''">User</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('list-pms') }}" wire:navigate :class="getActiveClasses('/interface')">
                            ...
                            <span class="ml-3"
                                :class="isActive('/interface') ? 'text-white font-medium' : ''">Interface</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('list-customer') }}" wire:navigate :class="getActiveClasses('/customer')">
                            ...
                            <span class="ml-3"
                                :class="isActive('/customer') ? 'text-white font-medium' : ''">Customer</span>
                        </a>
                    </li>
