    ...
    <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        ...
        <form wire:submit.prevent="updateCustomer">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <!-- PMS Selection -->
                <div>
                    <label for="pms_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">PMS
                        (Property
                        Management System)
                ...
                <!-- OS Server -->
                <div>
                    <label for="os_server" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">OS
                        Server
                        <span class="text-red-500">*</span></label>
                ...
                <!-- IP Server -->
                <div>
                    <label for="ip_server" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">IP
                        Server
                        <span class="text-red-500">*</span></label>
            ...
            @if ($pms_id)
                ...
                @if ($selectedPms)
                    <div
                        class="mb-6 p-3 bg-blue-50 border border-blue-200 rounded-lg dark:bg-blue-900/20 dark:border-blue-800">
            ...
            <div class="flex items-center space-x-4">
                <button type="submit"
                    ...
                    <span wire:loading>
                        <svg class="inline w-4 h-4 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
