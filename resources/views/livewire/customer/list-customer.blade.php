<div x-data="{ showModal: false, customerIdToDelete: null, customerNameToDelete: null }">
    <div class="py-2">
            ...
            <div class="flex items-center mb-4 sm:mb-0">
                <form class="sm:pr-3">
                    ...
                    <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                        <input type="search" wire:model.live="search" id="customer-search"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-base font-normal text-gray-500 dark:text-gray-400">Are you sure you want to
                        delete customer <br> <span class="font-bold" x-text="customerNameToDelete"></span>?</h3>
                    <button @click="$wire.deleteCustomer(customerIdToDelete); showModal = false; customerIdToDelete = null"
                        type="button"
