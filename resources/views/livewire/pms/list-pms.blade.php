                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-gray-600 dark:text-gray-300">Pms Name</th>
                            <th scope="col" class="px-6 py-3 text-gray-600 dark:text-gray-300">Description</th>
                            <th scope="col" class="px-6 py-3 text-gray-600 dark:text-gray-300">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($all_pms as $i=>$pms)
                            <tr
                                ...
                                <td class="px-6 py-4">{{ $pms->description }}</td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <!-- Delete Button -->
                                        <button type="button" wire:click="deletePms('{{ $pms->id }}')"
