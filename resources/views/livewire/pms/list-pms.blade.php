<div x-data="{ showModal: false, pmsIdToDelete: null, pmsNameToDelete: null }">
    <div class="py-2">
    ...
    <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
            ...
            <div class="flex items-center mb-4 sm:mb-0">
                <form class="sm:pr-3">
                    ...
                    <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                        <input type="search" wire:model.live="search" id="pms-search"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Search pms...." autocomplete="off">
                    </div>
                </form>
            </div>
            <a href="{{ route('add-pms') }}" wire:navigate
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-2 text-gray-600 dark:text-gray-300">Pms Name</th>
                            <th scope="col" class="px-4 py-2 text-gray-600 dark:text-gray-300">Description</th>
                            <th scope="col" class="px-4 py-2 text-gray-600 dark:text-gray-300">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($all_pms as $i=>$pms)
                            <tr
                                ...
                                <td class="px-4 py-2 whitespace-nowrap">{{ $pms->description }}</td>
                                <td class="px-4 py-2">
                                    <div class="flex items-center gap-2">
                                        <!-- Edit Button -->
                                        <a href="{{ route('edit-pms', $pms->id) }}" wire:navigate
                                        ...
                                        <!-- Delete Button -->
                                        <button @click="showModal = true; pmsIdToDelete = '{{ $pms->id }}'; pmsNameToDelete = '{{ $pms->pms_name }}'"
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center border-b py-4">
                                    No PMS found
                                </td>
                            </tr>
                        @endforelse
        ...
        <div class="pt-4 sm:pt-6">
            {{ $all_pms->links(data: ['scrollTo' => false]) }}
        </div>
    </div>
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-base font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete pms <br> <span class="font-bold" x-text="pmsNameToDelete"></span>?</h3>
                    <button @click="$wire.deletePms(pmsIdToDelete); showModal = false; pmsIdToDelete = null"
                        type="button"
