            ...
            <div class="flex items-center mb-4 sm:mb-0">
                <form class="sm:pr-3">
                    ...
                    <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                        <input type="search" wire:model.live="search" id="pms-search" autocomplete="off"
                                ...
                                <td class="px-4 py-2">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <a href="{{ route('edit-user', $user->id) }}" wire:navigate
                                            class="inline-flex items-center gap-1 p-2 text-xs font-medium text-white bg-yellow-500 rounded-sm hover:bg-yellow-600 focus:outline-none focus:ring-4 focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800 cursor-pointer">
