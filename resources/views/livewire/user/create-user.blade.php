                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-400 md:ml-2 dark:text-gray-500"
                                    aria-current="page">Create User</span>
                            </div>
                        </li>
                    </ol>
                </nav>
        ...
        <form wire:submit.prevent="saveUser">
            <div class="mb-6">
                ...
                <input type="text" id="username" wire:model="username"
                    class="bg-gray-50 border @error('username') border-red-500 dark:border-red-500 @else border-gray-300 @enderror text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div class="mb-6">
                ...
                <input type="text" id="name" wire:model="name"
                    class="bg-gray-50 border @error('name') border-red-500 dark:border-red-500 @else border-gray-300 @enderror text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div class="mb-6">
                ...
                <input type="email" id="email" wire:model="email"
                    class="bg-gray-50 border @error('email') border-red-500 dark:border-red-500 @else border-gray-300 @enderror text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
